...
from evis.dashboard.serializers.advisors import (
    AdvisorsCreateUpdateSerializer,
...
from evis.dashboard.serializers.exhibitors import ExhibitorVersionCreateSerializer, ExhibitorVersionListSerializer
...
class ExhibitorVersionViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == "list":
            return ExhibitorVersionListSerializer
        return ExhibitorVersionCreateSerializer
...
class AdvisorsViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == "list":
            ...
            return AdvisorsCreateUpdateSerializer
