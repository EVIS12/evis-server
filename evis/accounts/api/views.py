...
def activate_account(request, uid, token):
    ...
    DOMAIN = getattr(settings, "DOMAIN") or "server.evisagency.com"
    return render(
        request,
        "accounts/activate_account.html",
        {"uid": uid, "token": token, "url": f"{PROTOCOL}://{DOMAIN}/accounts/users/activation/"},
    )
...
def reset_password_confirm(request, uid, token):
    ...
    return render(
        ...
        "accounts/reset_password_confirm.html",
        {
            "uid": uid,
            "token": token,
            "reset_pass_confirm_url": f"{PROTOCOL}://{DOMAIN}/accounts/users/reset_password_confirm/",
        },
    )
