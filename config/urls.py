...
# Accounts
urlpatterns += [
    path(f"{api_prefix}awards/", include("evis.awards.api.urls")),
    ...
    path(f"{api_prefix}partners_sponsrs/", include("evis.partners_sponsrs.api.urls")),
    path(f"{api_prefix}attendees/", include("evis.attendees.api.urls")),
    path(f"{api_prefix}cpd/", include("evis.attendees.api.cpd_urls")),
]
if settings.DEBUG:
